...
export default class DoctorSearch extends Component {
  ...
  cardData = (data) => (
    <Grid item xs={4}>
      <Card style={{ borderRadius: '16px', display: 'inline-block', backgroundColor: 'rgb(145 6 63)', width: '100%' }}>
        <CardContent>
          <Box style={{ borderBottom: '1px solid black' }} pb={1}>
          ...
          <Box p={2}>
            <Typography variant="subtitle1" component="div" color='black' style={{ fontSize: '10px', fontWeight: 'bold' }}>Clinic Name - <span style={{ color: 'white' }}>{data.clinicName}</span></Typography>
            <Typography variant="subtitle1" component="div" color='black' style={{ fontSize: '10px', fontWeight: 'bold' }}>Address - <span style={{ color: 'white' }}>{data.address}</span></Typography>
            <Typography variant="subtitle1" component="div" color='black' style={{ fontSize: '10px', fontWeight: 'bold' }}>Timing - <span style={{ color: 'white' }}>{data.timing}</span></Typography>
            <Grid container>
              <Grid xs={4} item>
                <Typography variant="subtitle1" component="div" color='black' style={{ fontSize: '10px', fontWeight: 'bold' }}>Consultation Fee -  </Typography></Grid>
              <Grid xs={8} item>
                <Typography variant="subtitle1" component="div" color='white' style={{ fontSize: '10px' }}>{data.consultationFee[0]}</Typography>
                <Typography variant="subtitle1" component="div" color='white' style={{ fontSize: '10px' }}>{data.consultationFee[1]}</Typography>
              </Grid>
            </Grid>
            <Typography variant="subtitle1" component="div" color='black' style={{ fontSize: '10px', fontWeight: 'bold' }}>Reviews -<span style={{ color: 'white' }}> <Rating
              name="text-feedback"
              value={data.ratings}
              readOnly
              precision={0.5}
        ...
        <CardActions>
          <Grid container>
            <Grid item xs={6}>
              <Button size="small" style={{ backgroundColor: 'white', color: 'white' }}>Online Appointment</Button>
            </Grid>
            <Grid item xs={6}>
              <Button size="small" style={{ backgroundColor: 'white', color: 'white' }}>Offline Appointment</Button>
            </Grid>
          </Grid>
        </CardActions>
      </Card ></Grid>
